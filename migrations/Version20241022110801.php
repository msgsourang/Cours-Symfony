 ...
 */
final class Version20241022110801 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client (id SERIAL NOT NULL, compte_id INT DEFAULT NULL, surname VARCHAR(20) NOT NULL, telephone VARCHAR(9) NOT NULL, adresse VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');

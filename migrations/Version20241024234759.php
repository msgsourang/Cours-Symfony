 ...
 */
final class Version20241024234759 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dette RENAME COLUMN montantverser TO montant_verser');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dette RENAME COLUMN montant_verser TO montantverser');

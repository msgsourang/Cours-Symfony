 ...
 */
final class Version20241031005800 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dette ALTER statut DROP DEFAULT');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dette ALTER statut SET DEFAULT false');
